...
export default function RegisterForm() {
  ...
  const selectPlanOnChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
    setplanError(false);  // Reset error on plan change
  ...
  return (
    <div className="mx-auto vstack gap-3" style={{ width: "400px" }}>
      ...
      <div>
        ...
        <div>
          <input
            className={"me-2 form-check-input" + (genderError ? " is-danger" : "")} //"me-2 form-check-input"  
            type="radio" 
          ...
          Male 👨
          <input
            className={"mx-2 form-check-input" + (genderError ? " is-danger" : "")}//"mx-2 form-check-input"
            type="radio"
          ...
          {/* We just have to render the div below (Not using is-invalid bootstrap class) //text danger*/}
